...
public class EditProfileAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference profileRef = storageReference.child("Adminusers/" + fAuth.getCurrentUser().getUid() + "/profile.jpg");
            ...
            public void onClick(View v) {
                ...
                user.updateEmail(email).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        DocumentReference docRef = fStore.collection("Adminusers").document(user.getUid());
                        ...
                        docRef.update(edited).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(EditProfileAdmin.this, "Profile Updated", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(getApplicationContext(),ProfileAdmin.class));
                                finish();
                            }
                        });
                        Toast.makeText(EditProfileAdmin.this, "Information CHANGED.", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void uploadImageToFirebase(Uri imageUri) {
        ...
        final StorageReference fileRef = storageReference.child("Adminusers/" + fAuth.getCurrentUser().getUid() + "/profile.jpg");
