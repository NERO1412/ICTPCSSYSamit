...
public class ProfileAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("PROFILE ADMIN");
        ...
        DocumentReference documentReference = fStore.collection("Adminusers").document(userID);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        user.updatePassword(newPassword).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(ProfileAdmin.this, "Password Reset Succesfully", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(ProfileAdmin.this, "Password Reset Failed.", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
