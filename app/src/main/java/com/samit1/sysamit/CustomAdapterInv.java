...
public class CustomAdapterInv extends RecyclerView.Adapter<ViewHolder> {
    ...
    public CustomAdapterInv(EditAduanMainActivity editAduanMainActivity, List<ModelInv> modelInvList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Toast.makeText(editAduanMainActivity, "ADUAN TITLE : " + aduanTitle + "\n" +
            ...
            public void onItemlongClick(View view, final int position) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(editAduanMainActivity);
                //option to display in dialog
                String[] options = {"Update", "Delete", "Return"};
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0){
                            ...
                            Intent intent = new Intent(editAduanMainActivity, AduanManagementActivity.class);
                            //put data in intent
                        ...
                        if (which == 1){
                            //delete is clicked
                            editAduanMainActivity.deleteData(position);
                        }
                        if (which == 2){
                            //Return is clicked
                            return;
