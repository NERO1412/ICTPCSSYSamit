...
public class CustomAdapterAduan extends RecyclerView.Adapter<ViewHolder> {

    //ListitActivity listitActivity;
    StatusAduanActivity statusAduanActivity;
    ...
    public CustomAdapterAduan(StatusAduanActivity statusAduanActivity, List<ModelInv> modelInvList) {
        this.statusAduanActivity = statusAduanActivity;
